...
id int auto_increment primary key ,
add_name varchar(100) comment '开始地址',
end_name varchar(100) comment '目的地',
add_ip varchar(100) ,
end_ip varchar(100) ,
price decimal(10,2) comment '订单价格',
l_type int ,
pei_yong varchar(100),
pei_yongs varchar(100)
);
insert into locations(add_name,add_ip,l_type)values
